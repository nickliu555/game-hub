'use strict';
// Sim players for manual Shoot Ball host testing. Each bot joins as a real
...
//
//   node scripts/sim-shootball.js [count]     (default 2)
//
// Open the host at /shootball/host first, then run this; drag the sims onto
// teams in the lobby and hit Kick off.
const { io } = require('socket.io-client');
const URL = 'http://localhost:3000/shootball';
...
console.log('Spawned ' + count + ' Shoot Ball sim player(s). Ctrl-C to stop.');
