const games = [
    ...
    },
    {
        id: 'hearts',
        name: 'Hearts',
        tagline: 'Dodge the Queen, chase the Jack',
        emoji: '♥️',
        color: '#8E1B2E',
        category: 'Social',
        playerCount: '4',
        duration: '20–40 min',
        description: 'The classic trick-taking card game, dealt to four phones. Every heart you win costs you a point and the Queen of Spades costs you thirteen — but the Jack of Diamonds hands you ten back. Take all the penalty cards in one hand and you shoot the moon, dumping 26 points on everybody else. Lowest score wins.',
        rules: [
            'The host opens the game on a shared screen (TV, laptop, etc.)',
            'Players scan the QR code on their phones and enter a name — Hearts seats exactly four, so fill any empty seats with CPUs',
            'Drag the players in the lobby to set the seating order, then pick a target score of 50, 75 or 100',
            'Everyone is dealt 13 cards, then passes 3 to the left, right, across — and holds on every fourth hand',
            'The 2♣ leads the first trick; follow the suit led if you can, and you can’t lead hearts until they’ve been broken',
            'Highest card of the suit led wins the trick and leads the next one',
            'Each heart is +1 point, the Q♠ is +13, and the J♦ is −10 — points are bad, so duck them',
            'Win all 13 hearts and the Q♠ to shoot the moon: you score 0 and everyone else takes 26',
            'When anyone reaches the target score the game ends and the LOWEST score wins'
        ],
        hostPath: '/hearts/host',
        playPath: '/hearts/play',
    },
    {
        id: 'camo',
        name: 'Camo',
    ...
    },
    {
        id: 'nockey',
        name: 'Nockey',
        tagline: 'Two teams, one puck, pure chaos',
        emoji: '🏒',
        color: '#3E7CA6',
        category: 'Arcade',
        playerCount: '2–8 (+CPU)',
        duration: '3–8 min',
        description: 'Top-down disc hockey on the shared screen. Every player is a skater on the ice, steered from their phone with a thumbstick and a Hit button. Shove, pass, and blast the puck past the goalie into the opposing net. The rink grows with the teams — a tight 1v1 sheet or a full 4v4 arena. First team to the score limit wins; if the clock runs out level, it goes to sudden death.',
        rules: [
            'The host opens the game on a shared screen (TV, laptop, etc.)',
            ...
            'Your phone is a thumbstick plus a big Hit button — steer your skater around the rink',
            'Bump into the puck to nudge it; tap Hit when you\'re touching it to blast it',
            'Hit it into the opposing net to score — the rink resets for a face-off',
            'The rink size scales with the teams, from a tight 1v1 sheet to a full 4v4 arena',
            'First team to the score limit wins; otherwise the leader when the clock hits zero takes it',
            'Level at full time? Sudden death — next goal wins!'
        ],
